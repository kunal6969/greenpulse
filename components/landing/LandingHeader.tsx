    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-bg-primary/80 backdrop-blur-md border-b border-glass-border">
      <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center">
        <div className="flex items-center">
            <svg width="24" height="24" sm:width="28" sm:height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="text-md sm:text-lg font-bold ml-2 text-primary">GREENPULSE</span>
        </div>
        <button onClick={onLogin} className="bg-primary text-bg-primary font-bold py-2 px-3 sm:px-5 rounded-lg flex items-center space-x-2 hover:bg-primary-focus transition-transform duration-500 hover:scale-105 text-sm sm:text-base">
          <span>Dashboard</span>
